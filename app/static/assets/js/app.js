...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var options = {
        ...
        series: [{
            ...
            data: JSON.parse('{{ monthly_revenue|safe }}') // Dynamic from Django context
        }],
        xaxis: {
            categories: ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
        },
        colors: ['#38c66c'],
        fill: { type: 'gradient', gradient: { shade:'light', type:"vertical", shadeIntensity:0.4, inverseColors:false, opacityFrom:0.6, opacityTo:0.1, stops:[0,100] }},
    ...
    var options_weekly = {
        ...
        series: [{ name: 'Weekly Revenue', data: JSON.parse('{{ weekly_revenue|safe }}') }],
        xaxis: { categories: ['Week 1','Week 2','Week 3','Week 4','Week 5'] },
        colors: ['#38c66c']
    };
    new ApexCharts(document.querySelector("#revenueBarChart"), options_weekly).render();
});
